...
<style type="text/css">
	...
	width  : 24px;
	height : 24px;
	background-image : url(../common/images/button_autogen/button_24x24_all.gif);
}
...
/* ----- */
#buttonChangerBase0 { position: absolute; left :   0px; top :  32px; }
#buttonChangerBase1 { position: absolute; left :   0px; top :  72px; }
#buttonChangerBase2 { position: absolute; left :   0px; top : 112px; }
...
function initPage()
{
 	...
 	buttonChanger   = new kugi.SceneChanger( $("buttonChangerBases").children, $("buttonChangerContents").children );
 	upChanger       = new kugi.SceneChanger( upWindowObject.$("upBase").children, $("up_contents").children );
    
    btnDeleteUsage.onmouseup    = "showPage('S_08.jsp')";

 	

    btnBack.onmouseup           = "showHome()";
    


    setErrorTitle( 'Settings and Features' );

    onload_scroll();
}

function setLoyaltyButton()
{
	...
	if (loyaltyAccount != null) {
        btnLoyalty.onmouseup  = "showPage('S_05.jsp?loyalty=');";
	} else {
        btnLoyalty.onmouseup  = "showPage('S_02.jsp?loyalty=');";
	}
}
...
<!-- buttonChanger bases -->
<div id="buttonChangerBases">
    <div id="buttonChangerBase0"></div>
    <div id="buttonChangerBase1"></div>
    <div id="buttonChangerBase2"></div>
</div>

<!-- buttonChanger contents -->
<div class="preload" id="buttonChangerContents">
    <!-- mini EULA -->
	<!-- Delete Record -->
    <div class="btn_base button_256x40" id="btnDeleteUsage" shpbtn>
        <div class="inner_message tx12"><span class="vh_middle">
            Remove Nintendo DSi Shop Account</span></div>
        <div class="inner_image"><span class="vh_middle">
            <img src="/tss/tss/common/images//banner/record_a.png">
        </span></div>
    </div>
</div>

<div class="btn_base button_left" id="btnBack" shpbtn>
...
<div class="preload" id="up_contents">
    <div>
        <div class="tx16 cTitle page_title">Settings and Features</div>
