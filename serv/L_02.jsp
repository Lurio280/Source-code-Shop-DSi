...
<div class="message_long tx12">
	<div class="v_middle">
		The Nintendo DSi Shop is currently<BR>not available in the country you<BR>have selected.<BR><BR>Thank you for your understanding.</div>
</div>

<div class="btn_base button_center" id="btnDSiMenu" shpbtn>
    <span class="btn_inner tx16">DSi Menu</span>
</div>
