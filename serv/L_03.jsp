...
<div class="btn_base button_center" id="btnOK" shpbtn>
...
<div class="preload" id="up_contents">
    <div>
        ...
        <div class="up_message_scrollable tx12">
            Please note that the Nintendo DSi<BR>Shop includes content rated for<BR>various ages. If you want to restrict<BR>the displayed content to a certain age,<BR>please activate Parental Controls in<BR>the System Settings in the DSi Menu.</div>
    </div>
</div>
