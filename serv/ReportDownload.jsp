...
{
	initPageCommon();
	//waitSaveDataCreating();
	showPage('B_10.jsp?titleId=&reportDownloadDone=true');
}

function waitSaveDataCreating()
{
    if ( gkong.IsSaveDataCreating() )
    {
        setTimeout( waitSaveDataCreating, 300 );
    }
    else
    {
        showPage('B_10.jsp?titleId=&reportDownloadDone=true');
...
<div class="message h_middle tx16">
    Downloading...</div>
