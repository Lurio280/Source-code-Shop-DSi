...
function initPage()
{
    ...
    var showEulaFlag = null;
    if (ecSupportsSession()) {
	showEulaFlag = ec.getSessionValue("showEula");
    }
    
    trace("showEulaFlag:"+showEulaFlag);
    trace("getNewAgreedEulaVersion():"+getNewAgreedEulaVersion());
    ...
    // haven't agreed on a EULA this time (to prevent user seeing EULA twice)
    if (showEulaFlag != "false" && getNewAgreedEulaVersion()==null) {
...
{
    trace("check balance");
    getPointsBalance("onGetPointsBalanceDone", false);
}

function onGetPointsBalanceDone(progress)
{
    trace("check balance complete");
